								...
								<div class="span6">
									<div class="login-area">
										<div class="login-box" id="loginDiv">
											<div class="">
												<h3 class="login-header">ABKA Colombia S.A.S - CRM</h3>
		</div>
				...
				<div class="controls">
												...
												<div class="control-group signin-button">
													<div class="controls" id="forgotPassword">
														<button type="submit" class="btn btn-success sbutton">Ingresar</button>
											...
											<div class="login-subscript">
												<small> Desarrado por Novationsft S.A.S - {$CURRENT_VERSION}</small>
											</div>
				</div>
					...
					<div class="row-fluid">
						...
						<div class="span6 pull-right" >
							<div class="pull-right footer-icons">
								...
								<a href="https://www.facebook.com/novationsoft/"><img src="layouts/vlayout/skins/images/facebook.png"></a>
								&nbsp;<a href="https://twitter.com/novationsoft"><img src="layouts/vlayout/skins/images/twitter.png"></a>
								&nbsp;<a href="https://www.linkedin.com/groups/4011850"><img src="layouts/vlayout/skins/images/linkedin.png"></a>
								&nbsp;<a href="https://www.youtube.com/channel/UCfg78Q2SJdFHzp6KqKV9RJA"><img src="layouts/vlayout/skins/images/youtube.png"></a> 
							</div>
						</div>
					</div>   
				</div>    
