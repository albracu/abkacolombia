...
class Actas_ExportPDF_Action extends Vtiger_Action_Controller {
	...
	public function process(Vtiger_Request $request) {
		...
		$viewer->assign('NO_REMPLAZO', $recordModel->get('cf_858'));
		$viewer->assign('DIR_DESPACHO', $recordModel->get('cf_924'));
		...
		$viewer->assign('OBSERVACIONES_ADI', $recordModel->get('observaciones_adicionales'));
		...
		if ($recordModel->get('cf_922') == 1) {
			$viewer->assign('EQUIPO_ADIC', $check);
		}
		...
		$footer = '<div style="text-align:center;width:100%;font-size:10px;">PBX: 524 70 02/4860055/58/59 Cali: Avenida 5N 29AN – 57 B/San Vicente, Edificio Grupo Empresarial Abka<br> Bogotá: Carrera 27a 40a – 22 Barrio La Soledad <br> info@abkacolombia.com ';//'<div style="text-align:right;width:100%;border-top:1px solid #000000;">Impreso el: '.date('d-m-Y').'</div>';
